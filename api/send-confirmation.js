      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#111111;border-radius:16px 16px 0 0;padding:28px 32px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="middle">
                  <img src="${LOGO}" alt="Facilita SP Municípios" width="180" style="display:block;max-width:180px;height:auto;"/>
                </td>
        ...
        <tr>
          <td style="background:#FFFFFF;padding:36px 32px;">
            ...
            <p style="margin:0 0 28px;font-size:14px;font-weight:400;color:#4A5568;line-height:1.7;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td style="padding:7px 0;width:38%;vertical-align:top;">
                        <p style="margin:0;font-size:11px;color:#A0AEC0;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">Município</p>
                      </td>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:13px;font-weight:700;color:#111111;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">${municipio}</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:11px;color:#A0AEC0;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">Nome</p>
                      </td>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">${nome}</p>
                      </td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #EDF0F4;height:1px;padding:0;font-size:0;"></td></tr>
                    ...
                    <tr>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:11px;color:#A0AEC0;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">Cargo</p>
                      </td>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">${cargo}</p>
                      </td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #EDF0F4;height:1px;padding:0;font-size:0;"></td></tr>
                    ...
                    <tr>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:11px;color:#A0AEC0;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">WhatsApp</p>
                      </td>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">${telefone || '-'}</p>
                      </td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #EDF0F4;height:1px;padding:0;font-size:0;"></td></tr>
                    ...
                    <tr>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:11px;color:#A0AEC0;text-transform:uppercase;letter-spacing:0.08em;font-weight:600;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">E-mail</p>
                      </td>
                      <td style="padding:7px 0;vertical-align:top;">
                        <p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">${email}</p>
                      </td>
                    </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#111111;border-radius:14px;margin-bottom:28px;">
              <tr>
                <td style="padding:22px 24px;">
                  ...
                  <p style="margin:0 0 8px;font-size:16px;font-weight:700;color:#FFFFFF;font-family:'Poppins','Helvetica Neue',Arial,sans-serif;">Entrega de Selos Facilita SP</p>
