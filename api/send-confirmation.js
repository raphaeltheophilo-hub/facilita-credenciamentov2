        ...
        <tr>
          <td style="background:#FFFFFF;padding:32px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#F8F9FB;border:1px solid #E4E8EF;border-radius:12px;margin-bottom:24px;">
              ...
              <tr>
                <td style="padding:20px;">
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding:6px 0;width:40%;"><p style="margin:0;font-size:11px;color:#718096;text-transform:uppercase;letter-spacing:0.06em;font-weight:700;">Município</p></td>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:13px;font-weight:700;color:#111111;">${municipio}</p></td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #E4E8EF;height:1px;padding:0;"></td></tr>
                    <tr>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:11px;color:#718096;text-transform:uppercase;letter-spacing:0.06em;font-weight:700;">Nome</p></td>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;">${nome}</p></td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #E4E8EF;height:1px;padding:0;"></td></tr>
                    <tr>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:11px;color:#718096;text-transform:uppercase;letter-spacing:0.06em;font-weight:700;">Cargo</p></td>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;">${cargo}</p></td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #E4E8EF;height:1px;padding:0;"></td></tr>
                    <tr>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:11px;color:#718096;text-transform:uppercase;letter-spacing:0.06em;font-weight:700;">WhatsApp</p></td>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;">${telefone || '-'}</p></td>
                    </tr>
                    <tr><td colspan="2" style="border-bottom:1px solid #E4E8EF;height:1px;padding:0;"></td></tr>
                    <tr>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:11px;color:#718096;text-transform:uppercase;letter-spacing:0.06em;font-weight:700;">E-mail</p></td>
                      <td style="padding:6px 0;"><p style="margin:0;font-size:13px;font-weight:600;color:#1A2233;">${email}</p></td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding:20px 24px;">
                  ...
                  <p style="margin:6px 0 0;font-size:13px;color:rgba(255,255,255,0.65);">
                    📅 23 de junho de 2025 · 📍 Auditório CDI USP
                  </p>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0;font-size:13px;color:#718096;line-height:1.6;">
              ...
              <a href="mailto:spfacilita@gmail.com" style="color:#E8001C;font-weight:600;">spfacilita@gmail.com</a>.
            </p>
          </td>
        </tr>
